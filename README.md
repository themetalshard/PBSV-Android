...
It relied on the website https://pinewoodbuilders.org to get the data for the schedules On 21/01/2026 because of additional Cloudflare security the app could no longer fetch data from the website causing it to break.
